...
class CreatePrivateAlbumPage extends StatefulWidget {
  ...
  const CreatePrivateAlbumPage({super.key, this.mediaType = 0});

  @override
  State<CreatePrivateAlbumPage> createState() =>
      _CreatePrivateAlbumPageState();
}
...
class _CreatePrivateAlbumPageState extends State<CreatePrivateAlbumPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.mediaType == 1 ? '创建私密视频相册' : '创建私密相册'),
      ),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text('保存相册', style: TextStyle(fontSize: 18)),
              ),
            ),
          ],
        ),
  ...
  void _saveAlbum() {
    ...
    context.read<PrivateAlbumProvider>().addAlbum(
          name: name,
          icon: selectedIcon,
          color: selectedColor,
